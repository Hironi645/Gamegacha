 ...
 * Enhanced Version with VIP, Pass, Ban, Warning features
 */
...
function saveUserEdit() {
    ...
    addAdminLog('edit_user', username, `Coins: ${oldCoins}->${user.coins}, Gems: ${oldGems}->${user.gems}, Status: ${user.status}`);
    closeEditUserModal();
    renderUsersTable();
